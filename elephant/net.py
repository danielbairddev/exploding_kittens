"""GRU + Actor-Critic network for Elephant (numpy).

Architecture:
  GRU(N_EVENT=39 -> GRU_H=128): processes the full public event sequence.
  Trunk(GRU_H + N_SNAP=52 -> H1=128 -> H2=64): shared representation.
